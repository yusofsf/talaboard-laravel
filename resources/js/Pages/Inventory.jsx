        ...
        <AppLayout>
            <div className="page-wide">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 14, marginBottom: 20 }}>
                    <div style={{ background: 'linear-gradient(135deg,rgba(246,207,99,.16),rgba(199,154,46,.08))', border: '1px solid rgba(246,207,99,.3)', borderRadius: 16, padding: '18px 20px', textAlign: 'center' }}>
                    ...
                    <div style={{ background: 'rgba(255,255,255,.04)', border: '1px solid var(--line)', borderRadius: 16, padding: '18px 20px', textAlign: 'center' }}>
